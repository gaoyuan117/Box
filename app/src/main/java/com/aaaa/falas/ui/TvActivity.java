...
import com.aaaa.falas.ui.adapter.TvLeftAdapter;
import com.aaaa.falas.ui.adapter.TvRightAdapter;
...
public class TvActivity extends AppCompatActivity implements BaseQuickAdapter.OnItemClickListener {
    ...
    private com.aaaa.falas.widget.ViewStatusManager viewStatusmanager;
